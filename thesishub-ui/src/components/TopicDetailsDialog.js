      ...
      <div>
        ...
        <Dialog
          ...
          <div className="container-fluid">
            ...
            <FacebookLikeButton url={window.location + "topic?id=" + this.props.topic.id} />
            <TwitterButton url={window.location + "topic?id=" + this.props.topic.id} text={this.props.topic.title + ": " + this.props.topic.shortAbstract + " #Study"}/>
          </div>
        </Dialog>
        { (this.state.redirect) ? <Redirect to={"/topic?id="+this.props.topic.id} /> : "" }
      </div>
    );
  }
}
