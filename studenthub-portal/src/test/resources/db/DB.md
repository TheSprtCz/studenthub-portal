...
| id  | title               | shortAbstract                       | description                | creator | supervisors      | degrees                  | tags                      |
| --- | ------------------- | ----------------------------------- | -------------------------- | ------- | ---------------- | ------------------------ | ------------------------- |
| 1   | Melon cutter        | Create simple laser melon cutter    | Laser melon cutter         | 9       | [3,4,6]          | [PhD,MASTER]             | [Laser, Assembler, C]     |
| 2   | Dropwizard          | Simple app using Dropwizard stack   | REST endpoints             | 11      | [7,5,2]          | [BACHELOR, HIGH_SCHOOL]  | [Java, REST, Web]         |
| 3   | Eclipse plugin      | Create custom eclipse plugin        | Eclipse                    | 10      | [5,7,4]          | [MASTER, BACHELOR]       | [Java, C, Maven]          |
| 4   | React UI            | Create nice and functional UI       | JavaScript & React         | 9       | [6,3,2]          | [HIGH_SCHOOL,PhD]        | [JavaScript, Web]         |
